...
class MongodbPersistenceLayer extends Pxl.PersistenceLayerBase {
    ...
    logPxl(pxl) {
        ...
        return this.db.collection(this.collectionPxls).updateOne({ pxl }, { $inc: { count: 1 } }) // TODO: Make it more robust. It seems parallel calls to the same pxl make one call get modifiedCount = 0
            .then((response) => {
                console.log("aaaaaaa")

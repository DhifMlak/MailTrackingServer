...
class Pxl {
    ...
    trackPxl(req, res, next) {
        ...
        if (req.params && isString(req.params.linkId) && isString(req.params.pixelId)) {
    
            this.logPxl(req.params.pixelId).then((res) => {
           
            })
                .catch((err) => {
                    this.logPxlFailed(err, req.params.linkId, req.url)
                })
